...
exports.up = function(database) {
  const migrationFilePath = path.join(__dirname, 'sqls', '20240818090029-storefront-order-products-up.sql');
...
exports.down = function(database) {
  const rollbackFilePath = path.join(__dirname, 'sqls', '20240818090029-storefront-order-products-down.sql');
  return new PromiseDependency((resolve, reject) => {
